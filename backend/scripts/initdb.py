...
def step_init_prices():
    ...
    try:
        ...
        if db.query(CreditPrice).count() == 0:
            credit_prices = [
                {"name": "10元套餐", "amount": 10.00, "credits": 1000, "bonus_credits": 0, "is_active": True, "sort_order": 1, "description": "1000积分"},
                {"name": "50元套餐", "amount": 50.00, "credits": 5000, "bonus_credits": 200, "is_active": True, "sort_order": 2, "description": "5000积分+赠送200"},
                {"name": "100元套餐", "amount": 100.00, "credits": 10000, "bonus_credits": 500, "is_active": True, "sort_order": 3, "description": "10000积分+赠送500"},
                {"name": "200元套餐", "amount": 200.00, "credits": 20000, "bonus_credits": 1500, "is_active": True, "sort_order": 4, "description": "20000积分+赠送1500"},
            ]
        ...
        if db.query(MembershipPrice).count() == 0:
            membership_prices = [
                {"name": "月度会员", "membership_type": MembershipType.MONTHLY, "amount": 29.00, "original_amount": 39.00, "duration_days": 30, "is_active": True, "sort_order": 1, "description": "月度会员", "features": '["所有AI创作工具不限次数", "不消耗积分"]'},
                {"name": "季度会员", "membership_type": MembershipType.QUARTERLY, "amount": 79.00, "original_amount": 117.00, "duration_days": 90, "is_active": True, "sort_order": 2, "description": "季度会员", "features": '["所有AI创作工具不限次数", "优先客服支持"]'},
                {"name": "年度会员", "membership_type": MembershipType.YEARLY, "amount": 299.00, "original_amount": 468.00, "duration_days": 365, "is_active": True, "sort_order": 3, "description": "年度会员", "features": '["所有AI创作工具不限次数", "专属客服经理"]'},
            ]
...
def step_init_templates():
    ...
    try:
        ...
        if existing_count > 0:
            ...
            # 简化的模板数据
            templates = [
                {"name": "简约黑白", "description": "干净专业的黑白配色", "thumbnail": "/templates/simple-bw.png", "styles": {"container": {"padding": "20px"}, "h1": {"color": "#1a1a1a"}, "p": {"color": "#333333"}}, "is_system": True, "is_public": True},
                {"name": "微信绿", "description": "微信公众号原生风格", "thumbnail": "/templates/wechat-green.png", "styles": {"container": {"padding": "20px"}, "h1": {"color": "#07C160"}, "p": {"color": "#3f3f3f"}}, "is_system": True, "is_public": True},
                {"name": "科技蓝", "description": "科技感十足的蓝色主题", "thumbnail": "/templates/tech-blue.png", "styles": {"container": {"padding": "20px"}, "h1": {"color": "#1890ff"}, "p": {"color": "#333333"}}, "is_system": True, "is_public": True},
                {"name": "暖橙活力", "description": "活力四射的暖橙色主题", "thumbnail": "/templates/warm-orange.png", "styles": {"container": {"padding": "20px"}, "h1": {"color": "#ff6a00"}, "p": {"color": "#333333"}}, "is_system": True, "is_public": True},
                {"name": "文艺紫", "description": "优雅神秘的紫色主题", "thumbnail": "/templates/artistic-purple.png", "styles": {"container": {"padding": "20px"}, "h1": {"color": "#722ed1"}, "p": {"color": "#333333"}}, "is_system": True, "is_public": True},
            ]
...
def step_init_oauth_platforms():
    ...
    try:
        if db.query(PlatformConfig).count() > 0:
            ...
            platforms = [
                {"platform_id": "qwen", "platform_name": "通义千问", "platform_icon": "https://img.alicdn.com/imgextra/i1/O1CN01Z5paLz1O0zuCC7osS_!!6000000001644-55-tps-83-82.svg", "priority": 1, "oauth_config": {}, "litellm_config": {"provider": "qwen_web"}, "quota_config": {"daily_limit": 1000000}, "is_enabled": True},
                {"platform_id": "openai", "platform_name": "ChatGPT", "platform_icon": "https://cdn.oaistatic.com/_next/static/media/apple-touch-icon.59f2e898.png", "priority": 2, "oauth_config": {}, "litellm_config": {"provider": "chatgpt_web"}, "quota_config": {"daily_limit": 500000}, "is_enabled": True},
                {"platform_id": "claude", "platform_name": "Claude", "platform_icon": "https://claude.ai/images/claude_app_icon.png", "priority": 3, "oauth_config": {}, "litellm_config": {"provider": "claude_web"}, "quota_config": {"daily_limit": 500000}, "is_enabled": True},
                {"platform_id": "baidu", "platform_name": "文心一言", "platform_icon": "https://nlp-eb.cdn.bcebos.com/logo/favicon.ico", "priority": 4, "oauth_config": {}, "litellm_config": {"provider": "yiyan_web"}, "quota_config": {"daily_limit": 1000000}, "is_enabled": True},
                {"platform_id": "zhipu", "platform_name": "智谱清言", "platform_icon": "https://chatglm.cn/favicon.ico", "priority": 5, "oauth_config": {}, "litellm_config": {"provider": "chatglm_web"}, "quota_config": {"daily_limit": 1000000}, "is_enabled": True},
                {"platform_id": "doubao", "platform_name": "豆包", "platform_icon": "https://lf-flow-web-cdn.doubao.com/obj/flow-doubao/doubao/web/logo-icon.png", "priority": 8, "oauth_config": {}, "litellm_config": {"provider": "doubao_web"}, "quota_config": {"daily_limit": 1000000}, "is_enabled": True},
            ]
