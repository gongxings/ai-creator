<template>
  <div class="ai-accounts-management">
    <div class="section-header">
      <div class="header-content">
        <h3>AI平台账号管理</h3>
        <p class="section-subtitle">绑定豆包、通义千问等AI平台，使用平台免费额度进行创作，无需消耗积分</p>
      </div>
    ...
    <el-card v-if="accounts.length === 0 && !loading" class="guide-card">
      <div class="guide-content">
        <el-icon class="guide-icon"><Cpu /></el-icon>
        <h3>欢迎使用AI平台账号管理</h3>
        <p>绑定您的AI平台账号（如豆包、通义千问等），即可使用平台免费额度进行创作！</p>
...
import { Plus, Cpu, Link, Monitor, VideoCamera } from '@element-plus/icons-vue'
