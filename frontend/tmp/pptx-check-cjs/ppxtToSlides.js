            ...
            for (const el of sortedElements) {
                ...
                if (el.type === 'group') {
                    let groupElements = (el.elements || []).map((_el) => {
                        ...
                        if (el.rotate) {
                            const position = calculateRotatedPosition(originLeft, originTop, originWidth, originHeight, _el.left || 0, _el.top || 0, _el.width || 0, _el.height || 0, el.rotate, rotate);
                            left = position.x;
                            top = position.y;
                ...
                if (el.type === 'text') {
                    ...
                    convertedEl.defaultFontName = fontName;
